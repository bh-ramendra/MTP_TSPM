...
#     server_path = "/home/ramendra_2511ai39/TSPM/"
# else:
#     raise ValueError("Please select one server!")
...
parser.add_argument('--Temp_Selection', action='store_true', help='use temporal selection')
parser.add_argument('--Spatio_Perception', action='store_true', help='use spatio perception')
...
parser.add_argument('--checkpoint', type=str, default='TSPM_local', help='checkpoint name')
parser.add_argument('--model_save_dir', type=str, default='models/', help='model save directory')
parser.add_argument('--seed', type=int, default=42, help='random seed')

parser.add_argument('--audios_feat_dir', type=str, default='/DATA/ramendra_2511ai39/MUSIC-AVQA/data/feats/vggish/')
parser.add_argument('--visual_feat_dir', type=str, default='/DATA/ramendra_2511ai39/TSPM/clip_feats/frame_1fps_ViT-L14@336px/')
parser.add_argument('--audios_patch_dir', type=str, default='/DATA/ramendra_2511ai39/TSPM/clip_feats/frame_1fps_ViT-L14@336px/')
parser.add_argument('--visual_patch_dir', type=str, default='/DATA/ramendra_2511ai39/TSPM/clip_feats/frame_1fps_ViT-L14@336px/')


parser.add_argument('--qst_prompt_dir', type=str, default='/DATA/ramendra_2511ai39/TSPM/clip_feats/qaPrompt_ViT-L14@336px/')
parser.add_argument('--qst_feat_dir', type=str, default='/DATA/ramendra_2511ai39/TSPM/clip_feats/qaPrompt_ViT-L14@336px/')


parser.add_argument('--label_train', type=str, default='/DATA/ramendra_2511ai39/TSPM/dataset/split_que_id/music_avqa_train.json', help='train json file')
parser.add_argument('--label_val', type=str, default='/DATA/ramendra_2511ai39/TSPM/dataset/split_que_id/music_avqa_val.json', help='val json file')
parser.add_argument('--label_test', type=str, default='/DATA/ramendra_2511ai39/TSPM/dataset/split_que_id/music_avqa_test.json', help='test json file')